...
weapon_info_t* weapon_t::get_csweapon_info()
{
	if (!this) //-V704
		return nullptr;
	static auto fnGetWpnData = reinterpret_cast<weapon_info_t* (__thiscall*)(void*)>(util::FindSignature(crypt_str("client.dll"), crypt_str("55 8B EC 81 EC ? ? ? ? 53 8B D9 56 57 8D 8B ? ? ? ? 85 C9 75 04 33 FF EB 2F")));
